...
namespace EntityFrameworkTest.Migrations
{
    ...
    [Migration("20220524081649_relation AuthorBooks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrameworkTest.Models.AuthorBook", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkTest.Models.AuthorBook", b =>
                {
                    b.HasOne("EntityFrameworkTest.Models.Author", "Author")
                        .WithMany("AuthorBooks")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityFrameworkTest.Models.Book", "Book")
                        .WithMany("AuthorBooks")
